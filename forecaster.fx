...
})(window,document,'script','dataLayer','GTM-5NHK7Z8H');</script>
...
<style>
  ...
  <div class="team-logo-wrapper">
      ...
      <div class="text-wrapper">
          <h1 class="avitr-t-name avitor-icon-link"> <img src="magic-clear.png" alt="">Forex Master Fx</h1>
          <p class="gray-text">663 subscribers</p>
          <p class="info-text"> <img src="magic-clear.png" class="user-icon" alt=""> Highly Profitable Forex Signals <br><br>Trades in Currencies, Stocks, Cryptocurrency</p>
...
<noscript><iframe src="https://www.googletagmanager.com/ns.html?id=GTM-5NHK7Z8H"
